...
query($after: String, $first: Int){
  fulfilments(status:"AWAIT_ESTAFETA", createdOn:{
    from:"2020-11-01T00:00:00.192Z" to:"2020-11-30T23:59:59.192Z"
...
with open('cursor.csv','a') as c, open('output.csv','a') as output:
    ...
    output.write('Order Id, Order Ref, Fulfilment Id, Status, CreatedOn, Estafeta tracking Number\n')

    def get_all_data(cursor=None, first=20):
        global response

...
client.inject_token("Bearer 5226798c-29f3-4e9c-8a09-baf0f082dd79")
    ...
    with open('Date.csv','w') as f:
        ...
        for fulfilmentId in list(fulfilmentIds):
            ...
            audit = requests.get(AuditURL,
                        headers = {"Authorization": "Bearer 5226798c-29f3-4e9c-8a09-baf0f082dd79","Content-Type":"application/json"},
                        params = {"context.rootEntityType":"ORDER","count":"2000","context.rootEntityId":str(fulfilmentId),"from":fromDate, "name":"VerifyESTAFETARetrigger"}
                        )
            if(len(audit.text)>80):
